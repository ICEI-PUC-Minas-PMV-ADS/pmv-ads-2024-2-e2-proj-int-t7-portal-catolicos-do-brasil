...
| 3 | Pesquisar eventos paroquiais cadastrados pelas igrejas | 4 | Não houveram erros |O tempo para conclusão foi excelente assim que o usuario preenche um dos campos de pesquisa ("Estado","Cidade","Bairro") e clica no botão "Buscar" é mostrado para o usuario todos os eventos cadastrados no ("Estado","Cidade" ou "Bairro") pesquisado   | 0 erros  |
| 4 | Subir anuncio publicitário e verificar se o mesmo foi publicado corretamente | 4 | 0 erros  |O tempo varia pois o usario apos cadastrar o evento ele devera pesquisar o seu evento ou navegar pela pagina atre o encontrar-lo  | Nenhum erro encontrado durante a tarefa |
