...
<p>Demonstramos aqui os wireframes estáticos e interativo criados com base na proposta da aplicação a ser desenvolvida neste semestre por nossa equipe. Trazendo consigo um design tendo como foco principal o público que não dispensa a objetividade e praticidade em suas buscas, apresentamos: </p>

## Página Inicial
<p>Ela foi projetada para ser prática e intuitiva, facilitando a navegação e a busca por informações de paróquias e missas. A estrutura principal está dividida da seguinte forma:</p>
...
<p>Esta página exibe os resultados detalhados da pesquisa de missas realizadas pelos usuários. A estrutura principal está dividida da seguinte forma:</p>
...
<p>Nesta etapa, são coletadas as informações das paróquias que farão parte do portal, garantindo que os dados estejam atualizados e completos. A estrutura principal está dividida da seguinte forma:</p>
...
## Liturgia Diária
<p>Neste momento é apresentado o conteúdo litúrgico do dia, incluindo as leituras bíblicas e homilias. Sua estrutura é composta por:</p>
...
## Cadastro de Eventos
<p>A página de Cadastro de Eventos foi projetada para facilitar a inserção de eventos no portal, proporcionando um formulário simples e intuitivo para as paróquias divulgarem suas atividades. A estrutura principal está dividida da seguinte forma:</p>
	...
	<ul>
		...
		<ul>
			...
			<ul>
				...
				<li><strong>Data e Hora:</strong> Campos para inserir a data e hora de início e término do evento.</li>
...
## Santo do Dia
<p>Aqui é exibido uma breve biografia do santo celebrado no dia, acompanhada de uma imagem relacionada. A interface é simples e organizada, proporcionando fácil leitura e navegação. A estrutura principal está dividida da seguinte forma:</p>
